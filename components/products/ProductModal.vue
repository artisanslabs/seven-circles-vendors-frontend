...
export default {
  ...
  data() {
    return {
      ...
      max1500Length: (v) =>
        v ? v.length <= 1500 || this.$t("v.text_max_1500_length") : "",
      min10Length: (v) =>
        v ? v.length >= 10 || this.$t("v.text_min_10_length") : "",
      max20Length: (v) =>
        v ? v.length <= 20 || this.$t("v.text_max_20_length") : "",
      min8Length: (v) =>
        v ? v.length >= 8 || this.$t("v.text_min_8_length") : "",
      max14Length: (v) =>
        v ? v.length <= 14 || this.$t("v.text_max_14_length") : "",
